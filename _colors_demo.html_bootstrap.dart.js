...
$$.ReceivePortImpl = {"": "Object;_liblib5$_id<,_liblib5$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $.register$2$x($._globalState().currentContext, this._liblib5$_id, this);
  },
  $isReceivePort: true
};
...
$$.StreamController = {"": "EventSink;stream",
  ...
  add$1: function(_, value) {
    return this.stream._liblib6$_add$1(value);
  },
  $asEventSink: null
};
...
$$._StreamImpl = {"": "Stream;_state@",
  ...
  _liblib6$_add$1: function(value) {
    if (this.get$_liblib6$_isClosed())
  ...
  get$_liblib6$_add: function() {
    return new $.BoundClosure$1(this, "_liblib6$_add$1");
  },
  ...
  get$_liblib6$_isClosed: function() {
...
$$._DoneSubscription = {"": "Object;_handler<,_timer,_liblib6$_pauseCount",
  _handler$0: function() {
  ...
  get$_isComplete: function() {
    return this._timer == null && this._liblib6$_pauseCount === 0;
  },
  cancel$0: function() {
    if (this.get$_isComplete())
      return;
...
$$._SingleStreamMultiplexer = {"": "_MultiStreamImpl;_source,_liblib6$_subscription@,_nextLink,_previousLink,_state,_pendingEvents",
  _onSubscriptionStateChange$0: function() {
    var t1, t2;
    if (this.get$_hasListener()) {
      t1 = this.get$_liblib6$_add();
      t2 = this.get$_addError();
      this._liblib6$_subscription = this._source.listen$3$onDone$onError(t1, this.get$_close(), t2);
    } else {
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_liblib6$_stream,_cancelOnError<,_liblib6$_subscription@,_onData,_onError,_onDone",
  cancel$0: function() {
  ...
  _sendError$1: function(error) {
    this._onError$1(error);
    if (this._cancelOnError) {
      this._liblib6$_subscription.cancel$0();
      this._liblib6$_subscription = null;
    }
  },
  _sendDone$0: function() {
  ...
  _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, _cancelOnError) {
    ...
    this._liblib6$_subscription = this._liblib6$_stream._source.listen$3$onDone$onError(t1, this.get$_handleDone(), t2);
  },
  ...
  _handleData$2: function(inputEvent, sink) {
    ...
    try {
      ...
      if (t1.get$_cancelOnError()) {
        t1.get$_liblib6$_subscription().cancel$0();
...
$$._SplayTree = {"": "Object;",
  _splay$1: function(key) {
    ...
    for (right = left, left0 = right, comp = null; true;) {
      ...
      comp = this._liblib0$_compare$2(t1.get$key(current), key);
      t2 = $.getInterceptor$n(comp);
      if (t2.$gt(comp, 0)) {
        if (t1.get$left(current) == null)
          break;
        comp = this._liblib0$_compare$2($.get$key$x(t1.get$left(current)), key);
        if ($.$gt$n(comp, 0)) {
        ...
        if (t2.$lt(comp, 0)) {
          if (t1.get$right(current) == null)
            break;
          comp = this._liblib0$_compare$2($.get$key$x(t1.get$right(current)), key);
          if ($.$lt$n(comp, 0)) {
...
$$.SplayTreeMap = {"": "_SplayTree;_comparator,_root,_dummy,_count,_modificationCount,_splayCount",
  ...
  _liblib0$_compare$2: function(key1, key2) {
...
$$.Element__bindElement_closure = {"": "Closure;box_0,self_1",
  call$1: function(value) {
    ...
    t3 = this.box_0;
    if (t1) {
      t1 = $.get$attributes$x(t2);
      t1.$indexSet(t1, t3.name_0, "");
    } else {
      t1 = $.get$attributes$x(t2);
      t3 = t3.name_0;
      t1 = t1._element;
...
$$.Element__bindElement_closure0 = {"": "Closure;box_0,self_2",
  call$1: function(value) {
    var t1, t2;
    t1 = $.get$attributes$x(this.self_2);
    t2 = this.box_0.name_0;
    t1.$indexSet(t1, t2, value == null ? "" : $.S(value));
  },
  $isFunction: true
};
...
$$.PathObserver = {"": "Object;object,path,_isValid,_values<,_valueStream,_observer,_lastObserver,_liblib3$_lastValue,_liblib3$_scheduled",
  bindSync$1: function(callback) {
    var result = this.get$values(this).listen$1(callback);
  ...
  _deliverValues$0: function() {
    var newValue, t1;
    this._liblib3$_scheduled = false;
    newValue = this.get$value(this);
    t1 = this._liblib3$_lastValue;
    if (t1 == null ? newValue != null : t1 !== newValue) {
      this._values.stream._liblib6$_add$1(newValue);
      this._liblib3$_lastValue = newValue;
    }
  },
  get$_deliverValues: function() {
    return new $.BoundClosure$0(this, "_deliverValues$0");
  },
  _liblib3$_observe$0: function() {
    if (this._observer != null) {
      this._liblib3$_lastValue = this.get$value(this);
      this._observer.observe$0();
    }
  },
  get$_liblib3$_observe: function() {
    return new $.BoundClosure$0(this, "_liblib3$_observe$0");
  },
  ...
  _notifyChange$0: function() {
    if (this._liblib3$_scheduled)
      return;
    this._liblib3$_scheduled = true;
    var t1 = this.get$_deliverValues();
  ...
  PathObserver$2: function(object, path) {
    ...
    t1 = this.get$_liblib3$_observe();
    this._values = $.StreamController$(this.get$_liblib3$_unobserve(), t1, null, null, null);
    if (this._isValid) {
      segments = [];
      for (t1 = $.JSArray_methods.get$iterator($.trim$0$s(path).split(".")); t1.moveNext$0();) {
...
$$.CompoundBinding = {"": "ObservableBase;_combinator,_bindings,_values<,_liblib3$_scheduled,_disposed,_liblib3$_value,_observers,_stream,_changes",
  ...
  bind$3: function(_, $name, model, path) {
    ...
    result = t2.get$values(t2).listen$1(t3);
  ...
  resolve$0: function() {
    ...
    this.set$value(this, this._combinator$1(this._values));
  },
...
$$._InputBinding = {"": "Object;",
  _InputBinding$3: function(element, model, path) {
    ...
    this._eventSub = $._getStreamForInputType(this.element).listen$1(this.get$updateBinding());
  }
};
...
$$._CheckedBinding = {"": "_InputBinding;element,binding,_pathSub,_eventSub",
  ...
  updateBinding$1: function(e) {
    ...
    if (t2.type === "radio")
      for (t1 = $.get$iterator$ax($._getAssociatedRadioButtons(t2)); t1.moveNext$0() === true;) {
        checkedBinding = $.get$_checkedBinding$x(t1.get$current());
        if (checkedBinding != null) {
          t2 = checkedBinding.binding;
          t2.set$value(t2, false);
        }
      }
  },
  get$updateBinding: function() {
...
$$._getAssociatedRadioButtons_closure = {"": "Closure;element_0",
  call$1: function(el) {
    var t1, t2;
    t1 = this.element_0;
    if ($.$eq(el, t1) !== true)
...
$$._getAssociatedRadioButtons_closure0 = {"": "Closure;element_1",
  call$1: function(el) {
...
$$._createDeepCloneAndDecorateTemplates_closure = {"": "Closure;syntax_0",
  call$0: function() {
...
$$._addAttributeBindings_closure = {"": "Closure;element_0,model_1,syntax_2",
  call$2: function($name, value) {
    var t1;
    if ($.$eq(value, "") === true) {
      t1 = $.getInterceptor($name);
      t1 = t1.$eq($name, "bind") === true || t1.$eq($name, "repeat") === true;
    } else
      t1 = false;
    if (t1)
      value = "{{}}";
    $._parseAndBind(this.element_0, $name, value, this.model_1, this.syntax_2);
  },
  $isFunction: true
};

$$._parseAndBind_closure = {"": "Closure;tokens_0",
...
$$._TemplateIterator = {"": "Object;_templateElement,terminators,inputs,iteratedValue,_sub,_valueBinding",
  ...
  removeInstanceAt$1: function(index) {
    ...
    for (; t1 = $.getInterceptor(terminator), t1.$eq(terminator, previousTerminator) !== true; terminator = terminator0) {
      terminator0 = t1.get$previousNode(terminator);
      $._removeTemplateChild($parent, terminator);
    }
  },
  ...
  _handleChanges$1: function(splices) {
    var t1, syntax, splice, addIndex, i, addIndex0, t2, model, fragment;
    t1 = $.get$TemplateElement_syntax();
    syntax = t1.$index(t1, $.get$attributes$x(this._templateElement)._element.getAttribute("syntax"));
...
$$.FilteredElementList = {"": "ListBase;_node,_childNodes",
  ...
  contains$1: function(_, element) {
    return $.get$parentNode$x(element) === this._node;
  },
  setRange$4: function(_, start, end, iterable, skipCount) {
...
$$.ObservableMixin = {"": "Object;",
  ...
  _deliverChanges$0: function() {
    ...
    if (this.get$hasObservers() && changes != null)
      this._observers.stream._liblib6$_add$1(changes);
  },
...
$$.ListChangeRecord = {"": "ChangeRecord;index,removedCount,addedCount",
  ...
  ListChangeRecord$3$addedCount$removedCount: function(index, addedCount, removedCount) {
    if ($.$eq(this.addedCount, 0) === true && this.removedCount === 0)
...
$$.XColorselector = {"": "WebComponent;__e23,__e24,__e25,__e26,__e27,__e28,__e29,__e1,__e2,__e33,__e37,__e41,__e45,__e49,__e11<,__e12<,__e13<,__e16<,__e19<,__e22<,__e5<,__e8<,__e10,__e15,__e18,__e21,__e4,__e7,__t,_color,_host,_shadowRoots,_generatedRoots",
  ...
  set$color: function(_, v) {
    this._color = v;
    this.refresh$0();
  },
  get$hex_html: function() {
    return $.irgba_hexHtml(this.get$color(this));
  },
  set$hex_html: function(s) {
    this.set$color(this, $.hexHtml_irgba(s));
  },
  get$hex_irgba: function() {
    return $.irgba_hexString(this.get$color(this));
  },
  set$hex_irgba: function(s) {
    this.set$color(this, $.hexString_irgba(s));
  },
  get$rStr: function() {
    return $.JSInt_methods.toString$0($.irgba_r255(this.get$color(this)));
  },
  set$rStr: function(s) {
    if (s == null || $.$lt$n($.get$length$asx(s), 1))
      s = "0";
    this.set$color(this, $.irgba_r255_set(this.get$color(this), $.int_parse(s, null, 10)));
  },
  get$gStr: function() {
    return $.JSInt_methods.toString$0($.irgba_g255(this.get$color(this)));
  },
  set$gStr: function(s) {
    if (s == null || $.$lt$n($.get$length$asx(s), 1))
      s = "0";
    this.set$color(this, $.irgba_g255_set(this.get$color(this), $.int_parse(s, null, 10)));
  },
  get$bStr: function() {
    return $.JSInt_methods.toString$0($.irgba_b255(this.get$color(this)));
  },
  set$bStr: function(s) {
    if (s == null || $.$lt$n($.get$length$asx(s), 1))
      s = "0";
    this.set$color(this, $.irgba_b255_set(this.get$color(this), $.int_parse(s, null, 10)));
  },
  get$hStr: function() {
  ...
  set$hStr: function(s) {
    ...
    t1 = $.$div$n($.int_parse(s, null, 10), 360);
    if (0 >= hsv.length)
      throw $.ioore(0);
    hsv[0] = t1;
  ...
  set$sStr: function(s) {
    ...
    if (s == null || $.$lt$n($.get$length$asx(s), 1))
      s = "0";
    hsv = $.irgba_hsv(this.get$color(this));
    t1 = $.$div$n($.int_parse(s, null, 10), 100);
    if (1 >= hsv.length)
      throw $.ioore(1);
    hsv[1] = t1;
    this.set$color(this, $.hsv_irgba(hsv));
  ...
  get$triad: function() {
    return $.JSArray_methods.map$1($.hsl_triad($.irgba_hsl(this.get$color(this))), $.hsl_irgba);
  },
  get$tetrad: function() {
    return $.JSArray_methods.map$1($.hsl_tetrad($.irgba_hsl(this.get$color(this))), $.hsl_irgba);
  },
  get$splitcomplement: function() {
    return $.JSArray_methods.map$1($.hsl_splitcomplement($.irgba_hsl(this.get$color(this))), $.hsl_irgba);
  },
  get$analogous: function() {
    return $.JSArray_methods.map$1($.hsl_analogous($.irgba_hsl(this.get$color(this)), 6, 30), $.hsl_irgba);
  },
  ...
  sv_draw$0: function() {
    ...
    g = $.get$context2d$x(c);
    w1 = $.$sub$n(c.width, 4) / 100;
    h1 = $.$sub$n(c.height, 4) / 100;
    hsv = $.irgba_hsv(this.get$color(this));
    g.clearRect(0, 0, c.width, c.height);
    for (s0 = 0; s0 < 101; ++s0)
      for (t1 = s0 / 100, t2 = (100 - s0) * w1 + 2, v0 = 0; v0 < 101; ++v0) {
        if (0 >= hsv.length)
          throw $.ioore(0);
        g.fillStyle = $.JSString_methods.$add("#", $.JSString_methods.substring$1($.JSInt_methods.toRadixString$1(($.JSInt_methods.$shr($.hsv_irgba([hsv[0], t1, v0 / 100]), 8) | 16777216) >>> 0, 16), 1));
  ...
  h_draw$0: function() {
    ...
    w1 = $.$sub$n(c.width, 4);
    h1 = $.$sub$n(c.height, 4) / 100;
    t1 = $.irgba_hsv(this.get$color(this));
    if (0 >= t1.length)
      throw $.ioore(0);
    h0 = t1[0];
    g.clearRect(0, 0, c.width, c.height);
    for (y = 0; y < 101; ++y) {
      g.fillStyle = $.JSString_methods.$add("#", $.JSString_methods.substring$1($.JSInt_methods.toRadixString$1(($.JSInt_methods.$shr($.hsv_irgba([y / 100, 1, 1]), 8) | 16777216) >>> 0, 16), 1));
      g.fillRect(2, y * h1 + 2, w1, h1);
    }
    g.strokeStyle = "#000000";
...
$$.XColorselector_created_autogenerated_closure1 = {"": "Closure;this_7",
  call$0: function() {
    return this.this_7.get$rStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure5 = {"": "Closure;this_11",
  call$0: function() {
    return this.this_11.get$gStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure9 = {"": "Closure;this_15",
  call$0: function() {
    return this.this_15.get$bStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure19 = {"": "Closure;this_25",
  call$0: function() {
    return this.this_25.get$hStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure23 = {"": "Closure;this_29",
  call$0: function() {
    return this.this_29.get$sStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure27 = {"": "Closure;this_33",
  call$0: function() {
    return this.this_33.get$vStr();
  },
  $isFunction: true
};
...
$$.XColorselector_created_autogenerated_closure31 = {"": "Closure;this_37",
  call$1: function($$event) {
    var t1, t2, t3, t4;
    t1 = this.this_37;
...
$$.XColorselector_created_autogenerated_closure32 = {"": "Closure;this_38",
  call$1: function($$event) {
    var t1, t2, t3, t4;
    t1 = this.this_38;
    t2 = $.getInterceptor$x(t1);
...
$$.XColorselector_created_autogenerated_closure33 = {"": "Closure;this_39",
  call$1: function($$event) {
    var t1, t2, t3, t4;
    t1 = this.this_39;
    t2 = $.getInterceptor$x(t1);
...
$$.XColorselector_created_autogenerated_closure34 = {"": "Closure;this_40",
  call$1: function($$event) {
    var t1, t2, t3, t4;
    t1 = this.this_40;
    t2 = $.getInterceptor$x(t1);
...
$$._ExpressionObserver = {"": "Object;_id<,_expression,_liblib2$_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib2$_value",
...
$$.LinkedListNode = {"": "Object;_liblib1$_previous?,_liblib1$_next?,_list<,_liblib1$_value",
  ...
  append$1: function(_, e) {
    return $.LinkedListNode$_(e, this._list, $.getRuntimeTypeArgument(this, this.$asLinkedListNode, 0))._link$2(this, this._liblib1$_next);
  },
  remove$0: function(_) {
    var t1, t2;
    t1 = this._list;
...
$$._Watcher = {"": "Object;debugName,_getter,_callback,_lastValue",
  ...
  compareAndNotify$0: function() {
    ...
    if (this._compare$1(currentValue) === true) {
      ...
      this._callback$1($.ChangeNotification$(oldValue, currentValue, null));
      return true;
    }
    return false;
  },
...
$$.WebComponent = {"": "Object;",
  ...
  get$$$dom_lastChild: function(_) {
    return $.get$$$dom_lastChild$x(this.get$host(this));
  },
  ...
  append$1: function(_, e) {
    return $.append$1$x(this.get$host(this), e);
  },
...
$$.ButtonElement = {"": "Element;form=,type=,value%"};
...
$$.Element = {"": "Node;xtag%,_templateIterator%,_templateInstanceRef},_templateContent},_templateIsDecorated%,$$dom_children:children=,id=,innerHtml:innerHTML},tagName=",
  ...
  createInstance$0: function(receiver) {
    ...
    if (template == null)
      template = receiver;
    instance = $._createDeepCloneAndDecorateTemplates($.get$content$x(template), this.get$attributes(receiver)._element.getAttribute("syntax"));
    t1 = $.TemplateElement__instanceCreated;
    if (t1 != null)
      t1.stream._liblib6$_add$1(instance);
    return instance;
  },
...
$$.FieldSetElement = {"": "Element;form=,type="};
...
$$.KeygenElement = {"": "Element;form=,type="};
...
$$.Node = {"": "EventTarget;_templateInstance},$$dom_firstChild:firstChild=,$$dom_lastChild:lastChild=,nextNode:nextSibling=,document:ownerDocument=,parent:parentElement=,parentNode=,previousNode:previousSibling=,text:textContent}",
  ...
  bind$3: function(receiver, $name, model, path) {
    ...
    t2 = "Unhandled binding to Node: " + $.S(receiver) + " " + $.S($name) + " " + $.S(model) + " " + $.S(path);
    if (t1.get$_isConsoleDefined())
      console.error(t2);
  },
  unbind$1: function(receiver, $name) {
  },
...
$$.ObjectElement = {"": "Element;form=,type="};

$$.OptGroupElement = {"": "Element;"};

$$.OptionElement = {"": "Element;form=,value%"};

$$.OutputElement = {"": "Element;form=,type=,value%"};
...
$$.SelectElement = {"": "Element;form=,length=,type=,value%"};
...
$$.Text = {"": "CharacterData;",
  bind$3: function(receiver, $name, model, path) {
    ...
    result = t1.get$values(t1).listen$1(t2);
...
$$.TextAreaElement = {"": "Element;form=,rows=,type=,value%"};
...
$.Element__bindElement = function($self, $name, model, path) {
  ...
  t3 = t2.get$attributes($self);
  t4 = t1.name_0;
  t3 = t3._element;
  t3.getAttribute(t4);
  t3.removeAttribute(t4);
  if ($.endsWith$1$s(t1.name_0, "?")) {
    t3 = t1.name_0;
  ...
  result = t3.get$values(t3).listen$1(changed);
...
$.TemplateElement_decorate = function(template, instanceRef) {
  ...
  if (typeof template !== "object" || template === null || !$.getInterceptor(template).$isTemplateElement)
    t1.set$_templateContent(template, $.createDocumentFragment$0$x($._getTemplateContentsOwner(t1.get$document(template))));
  if (instanceRef != null) {
...
$._getStreamForInputType = function(element) {
  switch (element.type) {
    case "checkbox":
      return $.InputElement_methods.get$onClick(element);
    case "radio":
    case "select-multiple":
    case "select-one":
      return $.InputElement_methods.get$onChange(element);
    default:
      return $.InputElement_methods.get$onInput(element);
  }
};
...
$._isNodeInDocument = function(node) {
  var $document, t1;
...
$._getAssociatedRadioButtons = function(element) {
  var t1, radios;
  if ($._isNodeInDocument(element) !== true)
    return [];
  t1 = element.form;
  if (t1 != null) {
    t1 = $.get$nodes$x(t1);
    return t1.where$1(t1, new $._getAssociatedRadioButtons_closure(element));
  } else {
    radios = $._FrozenElementList$_wrap(element.ownerDocument.querySelectorAll("input[type=\"radio\"][name=\"" + $.S(element.name) + "\"]"), null);
    return radios.where$1(radios, new $._getAssociatedRadioButtons_closure0(element));
  }
};

$._createDeepCloneAndDecorateTemplates = function(node, syntax) {
  var t1, clone, c;
  t1 = $.getInterceptor$x(node);
  ...
  if (typeof clone === "object" && clone !== null && !!$.getInterceptor(clone).$isElement && $.get$isTemplate$x(clone)) {
    ...
    if (syntax != null)
      $.get$attributes$x(clone).putIfAbsent$2("syntax", new $._createDeepCloneAndDecorateTemplates_closure(syntax));
  }
  for (c = t1.get$$$dom_firstChild(node), t1 = $.getInterceptor$x(clone); c != null; c = $.get$nextNode$x(c))
    t1.append$1(clone, $._createDeepCloneAndDecorateTemplates(c, syntax));
  return clone;
};
...
$._bootstrapTemplatesRecursivelyFrom = function(node) {
  ...
  if (typeof node === "object" && node !== null && !!$.getInterceptor(node).$isElement && $.get$isTemplate$x(node))
    t1.call$1(node);
  $.forEach$1$ax(templateDescendents, t1);
};

$._addBindings = function(node, model, syntax) {
  var c;
  if (typeof node === "object" && node !== null && !!$.getInterceptor(node).$isElement)
    ...
    $._parseAndBind(node, "text", node.textContent, model, syntax);
  for (c = $.get$$$dom_firstChild$x(node); c != null; c = $.get$nextNode$x(c))
    $._addBindings(c, model, syntax);
};

$._addAttributeBindings = function(element, model, syntax) {
  $.forEach$1$ax($.get$attributes$x(element), new $._addAttributeBindings_closure(element, model, syntax));
};

$._parseAndBind = function(node, $name, text, model, syntax) {
  var tokens, t1, t2, replacementBinding, i, token;
  tokens = $._parseMustacheTokens(text);
  t1 = tokens.length;
  if (t1 !== 0)
    if (t1 === 1) {
      if (0 >= t1)
  ...
  if (t1 === 1) {
    if (0 >= t1)
      throw $.ioore(0);
    t2 = tokens[0].get$isBinding();
  } else
    t2 = false;
  if (t2) {
    if (0 >= t1)
      throw $.ioore(0);
    $._bindOrDelegate(node, $name, model, $.get$value$x(tokens[0]), syntax);
    return;
  }
  replacementBinding = $.CompoundBinding$(null);
  for (i = 0; i < tokens.length; ++i) {
    token = tokens[i];
    if (token.get$isBinding())
      $._bindOrDelegate(replacementBinding, i, model, $.get$value$x(token), syntax);
  }
  replacementBinding.set$combinator(new $._parseAndBind_closure(tokens));
  $.bind$3$x(node, $name, replacementBinding, "value");
};

$._bindOrDelegate = function(node, $name, model, path, syntax) {
  var delegateBinding;
  if (typeof path !== "string")
    return $._bindOrDelegate$bailout(1, node, $name, model, path, syntax);
  if (syntax != null) {
...
$._bindOrDelegate$bailout = function(state0, node, $name, model, path, syntax) {
  var delegateBinding;
  if (syntax != null) {
    delegateBinding = syntax.getBinding$4(model, path, $name, node);
    if (delegateBinding != null) {
...
$._parseMustacheTokens = function(s) {
  ...
  if (typeof $length !== "number")
    return $._parseMustacheTokens$bailout(1, s, result, t1, $length);
  for (lastIndex = 0; t2 = $.getInterceptor$n(lastIndex), t2.$lt(lastIndex, $length);) {
    ...
    if (t3.$lt(index, 0)) {
      ...
      if (t3.$gt(index, 0) && t2.$lt(lastIndex, index))
      ...
      if (t2.$lt(index, 0)) {
        ...
        if (result.length > 0 && $.JSArray_methods.get$last(result).get$isText()) {
      ...
      result.push($._BindingToken$($.JSString_methods.trim$0(t1.substring$2(s, lastIndex, index)), true));
...
$._parseMustacheTokens$bailout = function(state0, s, result, t1, $length) {
...
$._addTemplateInstanceRecord = function(fragment, model) {
  ...
  if (t1.get$$$dom_firstChild(fragment) == null)
    return;
  instanceRecord = $.TemplateInstance$(t1.get$$$dom_firstChild(fragment), t1.get$$$dom_lastChild(fragment), model);
...
$._removeAllBindingsRecursively = function(node) {
  var t1, c;
  t1 = $.getInterceptor$x(node);
  t1.unbindAll$0(node);
  for (c = t1.get$$$dom_firstChild(node); c != null; c = $.get$nextNode$x(c))
    $._removeAllBindingsRecursively(c);
};

$._removeTemplateChild = function($parent, child) {
  var t1, templateIterator;
  t1 = $.getInterceptor$x(child);
  t1.set$_templateInstance(child, null);
  if (typeof child === "object" && child !== null && !!$.getInterceptor(child).$isElement && $.get$isTemplate$x(child)) {
...
$._TemplateIterator$ = function(_templateElement) {
  var t1 = new $._TemplateIterator(_templateElement, [], $.CompoundBinding$($._TemplateIterator_resolveInputs), null, null, null);
...
$.Lists_indexOf = function(a, element, startIndex, endIndex) {
  ...
  if (startIndex < 0)
    startIndex = 0;
  if (startIndex !== (startIndex | 0))
    return $.Lists_indexOf$bailout(2, 0, startIndex, endIndex, t1);
  for (i = startIndex; i < endIndex; ++i)
    if (i < 0 || i >= t1)
      throw $.ioore(i);
  return -1;
...
$.Lists_indexOf$bailout = function(state0, a, startIndex, endIndex, t1) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
...
$.deliverChangeRecords = function() {
  ...
  if ($._deliverCallbacks == null)
    return;
  for (; t1 = $._deliverCallbacks, !t1.get$isEmpty(t1);) {
...
$.irgba_r255 = function(c) {
  return $.JSInt_methods.$shr($.$and$n(c, 4278190080), 24);
};

$.irgba_r255_set = function(c, r) {
  return ($.$and$n(c, 16777215) | $.$shl$n(r, 24)) >>> 0;
};

$.irgba_g255 = function(c) {
  return $.JSInt_methods.$shr($.$and$n(c, 16711680), 16);
};

$.irgba_g255_set = function(c, g) {
  return ($.$and$n(c, 4278255615) | $.$shl$n(g, 16)) >>> 0;
};

$.irgba_b255 = function(c) {
  return $.JSInt_methods.$shr($.$and$n(c, 65280), 8);
};

$.irgba_b255_set = function(c, b) {
  return ($.$and$n(c, 4294902015) | $.$shl$n(b, 8)) >>> 0;
};
...
$.irgba_hsl = function(c) {
  var t1, r, g, b, max, min, l, h, s, d;
  t1 = $.getInterceptor$n(c);
  r = $.JSInt_methods.$shr(t1.$and(c, 4278190080), 24) / 255;
  g = $.JSInt_methods.$shr(t1.$and(c, 16711680), 16) / 255;
  b = $.JSInt_methods.$shr(t1.$and(c, 65280), 8) / 255;
  max = $.max($.max(r, g), b);
  min = $.min($.min(r, g), b);
  t1 = max + min;
  l = t1 / 2;
...
$.irgba_hsv = function(c) {
  ...
  d = t1.$sub(max, min);
  s = t1.$eq(max, 0) === true ? 0 : $.$div$n(d, max);
...
$.hsl_analogous = function(hsl, results, slices) {
  ...
  l = hsl[2];
  for (i = 1; i < results; ++i) {
    h = $.JSNumber_methods.$mod(h + part, 360);
    if (i >= t1)
      throw $.ioore(i);
    ret[i] = [h / 360, s, l];
  }
...
$.irgba_hexHtml = function(c) {
  if (typeof c !== "number")
    throw c.$shr();
  return $.JSString_methods.$add("#", $.JSString_methods.substring$1($.JSInt_methods.toRadixString$1(($.JSNumber_methods.$shr(c, 8) | 16777216) >>> 0, 16), 1));
};

$.hexHtml_irgba = function(s) {
  return ($.$shl$n($.Primitives_parseInt($.substring$1$s(s == null || $.$lt$n($.get$length$asx(s), 2) ? "#0" : s, 1), 16, null), 8) | 255) >>> 0;
};
...
$.hexString_irgba = function(s) {
  return $.Primitives_parseInt($.substring$1$s(s == null || $.$lt$n($.get$length$asx(s), 3) ? "0x0" : s, 2), 16, null);
};
...
$._TemplateIterator_resolveInputs.call$1 = $._TemplateIterator_resolveInputs;
$._TemplateIterator_resolveInputs.$name = "_TemplateIterator_resolveInputs";
$.deliverChangeRecords.call$0 = $.deliverChangeRecords;
$.deliverChangeRecords.$name = "deliverChangeRecords";
$.hsl_irgba.call$1 = $.hsl_irgba;
$.hsl_irgba.$name = "hsl_irgba";
$.hsv_irgba.call$1 = $.hsv_irgba;
$.hsv_irgba.$name = "hsv_irgba";
...
$.InputElement_methods = $.InputElement.prototype;
...
Isolate.$lazy($, "__html1", "XColorselector___html1", "get$XColorselector___html1", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__html10", "XColorselector___html10", "get$XColorselector___html10", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__html11", "XColorselector___html11", "get$XColorselector___html11", function() {
  return $.Element_Element$html("<span class=\"cs_sampletxt\"></span>");
});
Isolate.$lazy($, "__html12", "XColorselector___html12", "get$XColorselector___html12", function() {
  return $.Element_Element$html("<span class=\"cs_samplebox\" style=\"background-color:{{irgba_hexHtml(c)}}\"></span>");
});
Isolate.$lazy($, "__html13", "XColorselector___html13", "get$XColorselector___html13", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__html14", "XColorselector___html14", "get$XColorselector___html14", function() {
  return $.Element_Element$html("<span class=\"cs_sampletxt\"></span>");
});
Isolate.$lazy($, "__html15", "XColorselector___html15", "get$XColorselector___html15", function() {
  return $.Element_Element$html("<span class=\"cs_samplebox\" style=\"background-color:{{irgba_hexHtml(c)}}\"></span>");
});
Isolate.$lazy($, "__html2", "XColorselector___html2", "get$XColorselector___html2", function() {
  return $.Element_Element$html("<span class=\"cs_sampletxt\"></span>");
});
Isolate.$lazy($, "__html3", "XColorselector___html3", "get$XColorselector___html3", function() {
  return $.Element_Element$html("<span class=\"cs_samplebox\" style=\"background-color:{{irgba_hexHtml(c)}}\"></span>");
});
Isolate.$lazy($, "__html4", "XColorselector___html4", "get$XColorselector___html4", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__html5", "XColorselector___html5", "get$XColorselector___html5", function() {
  return $.Element_Element$html("<span class=\"cs_sampletxt\"></span>");
});
Isolate.$lazy($, "__html6", "XColorselector___html6", "get$XColorselector___html6", function() {
  return $.Element_Element$html("<span class=\"cs_samplebox\" style=\"background-color:{{irgba_hexHtml(c)}}\"></span>");
});
Isolate.$lazy($, "__html7", "XColorselector___html7", "get$XColorselector___html7", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__html8", "XColorselector___html8", "get$XColorselector___html8", function() {
  return $.Element_Element$html("<span class=\"cs_sampletxt\"></span>");
});
Isolate.$lazy($, "__html9", "XColorselector___html9", "get$XColorselector___html9", function() {
  return $.Element_Element$html("<span class=\"cs_samplebox\" style=\"background-color:{{irgba_hexHtml(c)}}\"></span>");
});
...
//@ sourceMappingURL=_colors_demo.html_bootstrap.dart.js.map
