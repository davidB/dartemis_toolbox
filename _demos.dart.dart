// Auto-generated from demos.html.
// DO NOT EDIT.
...
import '_from_packages/dartemis_toolbox/widgets/_xtchart.dart.dart';
import 'dart:html';
...
dynamic __$activeDemo = null;
dynamic get activeDemo {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'activeDemo');
  }
  return __$activeDemo;
}
set activeDemo(dynamic value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'activeDemo',
        __$activeDemo, value);
  }
  __$activeDemo = value;
}
...
void init_autogenerated() {
  ...
  final __html0 = new autogenerated.Element.html('<li class=""><a></a></li>');
  var __e3, __e4;
  var __t = new autogenerated.Template(__root);
  __e3 = __root.nodes[1].nodes[5].nodes[1].nodes[1];
  __t.loop(__e3, () => initDemo.keys, ($list, $index, __t) {
    var k = $list[$index];
    var __e1, __e2;
    ...
    __t.oneWayBind(() => '#/${k}', (e) { if (__e1.href != e) __e1.href = e; }, false, true);
    __t.bindClass(__e2, () => (activeDemo == k) ? 'active' : '', false);
  __t.addAll([new autogenerated.Text('\n            '),
      __e2,
      new autogenerated.Text('\n          ')]);
  });
  __e4 = __root.nodes[1].nodes[7].nodes[3];
  __t.component(new XTchart()..host = __e4);
  __t.create();
  __t.insert();
}

//# sourceMappingURL=_demos.dart.dart.map